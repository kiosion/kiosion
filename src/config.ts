...
export default {
  endpoints: {
    ...
    music:
      'https://toru.kio.dev/api/v1/kiosion?border_width=0&border_radius=26',
  },
  limits: {
    topRepos: 6,
    recentRepos: 6,
  ...
  content: {
    ...
    description: `I'm a full-stack software engineer based out of Toronto working in Cybersec. I like building stuff for the web.
